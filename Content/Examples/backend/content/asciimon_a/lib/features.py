...
def content_ring(lat, lng, item_list, distance=6, random_y=True):
    response = {}
    ...
    for i in range(len(item_list)):
        ...
        random.seed(lat + lng * (i+1))
        obj_color = rgb2hex(random.choice([c_a, c_b, c_c]))
        ...
        obj_info = demo_info(curr_itm, round_lat * i, round_lng * i)
